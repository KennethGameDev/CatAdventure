...
@export_enum("Tuna", "Bread", "Cheese", "Apple") var food_type: String = "Tuna"
...
func _ready():
	...
	match food_type:
		"Tuna":
			sprites.animation = "tuna"
		"Bread":
			sprites.animation = "bread"
		"Cheese":
			sprites.animation = "cheese"
		"Apple":
			sprites.animation = "apple"
...
=======
		main.player.change_health_by(5)
